      ...
      <div className="container">
          ...
          <div className="row">
            <article className="col-md-8 col-xs-12">
                ...
                <ul>
                    <li>develop a fully customised steel framing product</li>
                    <li>optionally customise steel frames to suit building processes</li>
                    <li>optionally develop assembly processes for onsite installation that fits with specific building needs.</li>
                </ul>
